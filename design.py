...
"")
        ...
        self.but_calc = QPushButton(self.centralwidget)
        self.but_calc.setObjectName(u"but_calc")
        sizePolicy2.setHeightForWidth(self.but_calc.sizePolicy().hasHeightForWidth())
        self.but_calc.setSizePolicy(sizePolicy2)
        self.but_calc.setCursor(QCursor(Qt.PointingHandCursor))

        self.layout_buttons.addWidget(self.but_calc, 5, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_mul.setText(QCoreApplication.translate("MainWindow", u"\u0445", None))
#if QT_CONFIG(shortcut)
